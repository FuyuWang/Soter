...
class Decoder(nn.Module):
    ...
    def __init__(
            ...
            order_size=1, tile_size=1, num_primes=1):
    ...
    def forward(self, trg_seq, trg_mask, return_attns=False):
        ...
        dec_output += self.sp_tile2_emb(trg_seq[:, :, self.num_primes + 1])
...
class Transformer(nn.Module):
    ...
    def __init__(
        ...
        self.decoder = Decoder(
            ...
            pad_idx=self.trg_pad_idx, dropout=dropout, scale_emb=scale_emb,
            order_size=order_size, tile_size=tile_size, num_primes=num_primes)
    ...
    def forward(self, trg_seq):
        ...
        return order_logit, tile_logits, sp_tile2_logit
