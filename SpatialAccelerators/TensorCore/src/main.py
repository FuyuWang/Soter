...
def run():
    ...
    # architectures = ['tensorcore_4x', 'tensorcore_16x', 'tensorcore_64x', 'tensorcore_256x', 'tensorcore_1024x']
    # architectures = ['tensorcore', 'tensorcore_16x', 'tensorcore_64x']
    architectures = ['tensorcore']
    for architecture in architectures:
        # dnns = ['mobilenetv2', 'unet', 'resnet50', 'transformer']
        # dnns = ['transformer', 'bertlarge']
        # dnns = ['gpt1', 'gpt3']
        dnns = ['palm']
        for dnn in dnns:
            ...
            for input_size in input_sizes:
                ...
                for i, layer in enumerate(layers):
                    ...
                    with open(os.path.join(problem_dir, '{}_problems/{}.yaml'.format(dnn, layer)), 'r') as fd:
                        ...
                        problem['problem']['instance']['N'] = layer_problem['problem']['N'] * input_size
